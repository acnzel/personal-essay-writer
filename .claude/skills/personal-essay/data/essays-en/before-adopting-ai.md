...
Being a PO is something anyone can do, but not just anyone should do—that's my thinking. It might sound old-fashioned, but that's what I've observed in the field over the past few years. When problems arise, I often see a tendency to focus only on symptoms and try to fix only the symptoms. When users say something is inconvenient, the focus goes to eliminating that inconvenience, without digging into why it's inconvenient or where that inconvenience originates.
...
So they built reusable rockets, and now the cost has dropped to about $2,200 per kg—more than a 20-fold reduction. With reuse, they say it's another 30% cheaper. A tremendous change. The problem wasn't "space development is expensive" but "rockets are disposable."
...
If there's something I want to solve and someone holds the key to it, I need to have more conversations with that person and build a relationship. Helping each other and working together—perhaps that's the essence of working in an organization. If AI is playing that role these days, then it's doing quite well. And if AI is truly doing that role well, unfortunately, that person may not be needed in that area.
...
Yet we expect people to grow and change. We expect results without giving feedback. It makes me wonder if we're being too harsh on humans. Perhaps being honest, frequent, and specific with people—like we are with AI—might actually be better for them.

## Where Technology Belongs

I've seen an impressive case related to this. In one organization, step 7 of an 18-step process was constantly problematic. But when they documented that step, everyone agreed "something's wrong here" while unable to agree on "so what should we do?" In the end, just writing down what they were doing led to progress in understanding and aligning on the actual process.

There are also mixed views on processes. Processes help achieve stable, average results, but sometimes flexibility is needed too. I think it's about finding balance depending on the situation.
